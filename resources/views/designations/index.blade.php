...
@section('content')
    ...
    <div class="container-fluid">
        <a class="btn btn-primary mt-3 mb-3" href="{{ route('designations.create') }}">Add New Teacher</a>
<div class="row">
                ...
                <table class="table table-responsive table-responsive-sm table-responsive-md table-responsive-lg text-capitalize text-center">
                        ...
                        @foreach ($designations as $designation)
                            <tr style="font-size: 14px">
                                ...
                                <td>
                                    <form class="mt-2" action="{{ route('designations.destroy', $designation->id) }}"
                                        method="POST">

                                        <a href="{{ route('designations.edit', $designation->id) }}" target="_blank"><i class="fa fa-edit" style="color: #f5e52e;"></i></a>
                                        @csrf
                                        @method('DELETE')
